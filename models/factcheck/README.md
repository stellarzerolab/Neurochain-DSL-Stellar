# FactCheck (entailment / neutral / contradiction)

Expected files after downloading the model pack:

- `models/factcheck/model.onnx`
- `models/factcheck/tokenizer.json`
- `models/factcheck/vocab.txt`
...
- Training data can introduce attribution requirements; see `models/THIRD_PARTY_NOTICES.md`.
