...
nullifier. `fixtures/groth16_approved.json`,
...
chain, accepts each genuine scenario as its attested decision, persists its
nullifier, rejects replay as contract error `3` and rejects a mutated proof as
contract error `2`.
